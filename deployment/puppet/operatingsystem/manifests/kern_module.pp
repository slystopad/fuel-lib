##
## picked from http://projects.puppetlabs.com/projects/1/wiki/Kernel_Modules_Patterns
##
## The resource to handle loading/unloading Linux kernel modules and also
## ensuring they are loaded automatically at boot.
##
## Example:
...
define operatingsystem::kern_module ($ensure) {
